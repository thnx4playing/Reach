...
export const COYOTE_MS = 120;   // grace after leaving ground
export const BUFFER_MS = 140;   // grace after pressing jump early/late
export const LIFTOFF_IGNORE_FRAMES = 3;
